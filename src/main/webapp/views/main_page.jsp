                ...
                <div class="center_targets">
                    ...
                    <div class = "center_add_target2">
                        <div class="image_margin">
                            <div class="image"><img  src="${pageContext.request.contextPath}/images/tracer.png" width="230" height="230"alt="" /></div>

                            <a href="${pageContext.request.contextPath}/login" class="button" style="width: 176px">${head_log_in}</a>
                            <a href="${pageContext.request.contextPath}/create" class="button" style="width: 176px">${head_createp_rofile}</a>
                    ...
                    <div class = "center_add_target">
                        <div class="image_margin">
                            <div class="image"><img  src="${pageContext.request.contextPath}/images/testuser.png" width="230" height="230"alt="" />
                            </div>
                            <a href="${pageContext.request.contextPath}/login" class="button" style="width: 176px;background:#A80038">Try on test user</a>
                        </div>
                    </div>
`
                </div>
